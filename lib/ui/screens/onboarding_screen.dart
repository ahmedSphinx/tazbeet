          ...
          Expanded(
            ...
            child: ElevatedButton(
              ...
              child: _isAnimating
                  ...
                  : Row(mainAxisSize: MainAxisSize.min, children: [Text(_isLastPage ? AppLocalizations.of(context)!.getStarted : AppLocalizations.of(context)!.next), const SizedBox(width: 8), Icon(_isLastPage ? Icons.check_circle : Icons.arrow_forward)]),
            ),
          ),
        ],
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(AppLocalizations.of(context)!.adjustTheseSettingsToMakeTheAppWorkBetterForYou, style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7))),
            const SizedBox(height: 32),

            // High Contrast
            _buildAccessibilityOption(AppLocalizations.of(context)!.highContrast, AppLocalizations.of(context)!.increaseColorContrastForBetterVisibility, Icons.contrast, _highContrast, (value) => setState(() => _highContrast = value)),
            ...
            // Reduced Motion
            _buildAccessibilityOption(AppLocalizations.of(context)!.reducedMotion, AppLocalizations.of(context)!.minimizeAnimationsAndTransitions, Icons.motion_photos_pause, _reducedMotion, (value) => setState(() => _reducedMotion = value)),
