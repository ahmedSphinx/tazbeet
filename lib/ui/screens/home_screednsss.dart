...
import 'package:tazbeet/services/localization_service.dart';
...
class _HomeScreennState extends State<HomeScreenn> with TickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        FilterChip(
                          label: Text(
                            AppLocalizations.of(context).incompleteLabel,
                          ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => BlocBuilder<CategoryBloc, CategoryState>(
        builder: (context, state) => Padding(
          ...
          child: Wrap(
            children: [
              ListTile(title: Text(AppLocalizations.of(context).addTaskTitle)),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                      ...
                      items: TaskPriority.values
                          .map(
                            (priority) => DropdownMenuItem<TaskPriority>(
                              value: priority,
                              child: Text(
                                LocalizationService.getPriorityLabel(priority),
                              ),
                            ),
                          )
                          .toList(),
        ...
        title: _isSearching && _selectedIndex == 0
            ...
            : Text(
                _selectedIndex == 0
                    ...
                    : _selectedIndex == 4
                    ? AppLocalizations.of(context).moodTracking
                    : '',
        ...
        child: ListView(
          ...
          children: [
            ...
            /* ListTile(
              ...
              title: Text(AppLocalizations.of(context)!.HomeScreennTitle),
...
class HomeScreennBody extends StatefulWidget {
  const HomeScreennBody({super.key});

  @override
  State<HomeScreennBody> createState() => _HomeScreennBodyState();
}

class _HomeScreennBodyState extends State<HomeScreennBody> {
  String? _selectedCategoryId;
                      ...
                      children: [
                        Expanded(
                          child: ProgressIndicatorCard(
                            ...
                            progress:
                                completedTasks /
                                (todayTasks > 0 ? todayTasks : 8).toDouble(),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => BlocBuilder<CategoryBloc, CategoryState>(
        builder: (context, state) => Padding(
          ...
          child: Wrap(
            children: [
              ListTile(title: Text(AppLocalizations.of(context).editTaskTitle)),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
  ...
  void _showDeleteConfirmation(Task task) {
    showModalBottomSheet(
      ...
      builder: (context) => Wrap(
        children: [
          ListTile(title: Text(AppLocalizations.of(context).deleteTaskTitle)),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Text(
