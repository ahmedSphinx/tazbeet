...
abstract class AppLocalizations {
  ...
  /// No description provided for @achievementSystem.
  ///
  /// In en, this message translates to:
  /// **'Achievement system'**
  ...
  String get adaptiveBreakSuggestions;
  ...
  /// No description provided for @adaptivePomodoroTiming.
  ///
  /// In en, this message translates to:
  /// **'Adaptive Pomodoro timing'**
  String get adaptivePomodoroTiming;
  ...
  /// In en, this message translates to:
  /// **'Add First Subtask'**
  String get addFirstSubtask;

  /// No description provided for @addLevelThreeSubtask.
  ///
  /// In en, this message translates to:
  /// **'Add Level-3 Subtask'**
  String get addLevelThreeSubtask;
  ...
  /// No description provided for @addSubSubtask.
  ///
  /// In en, this message translates to:
  /// **'Add Subtask'**
  String get addSubSubtask;
  ...
  /// No description provided for @afternoonVibes.
  ///
  /// In en, this message translates to:
  /// **'Afternoon vibes 🌻'**
  ...
  String get areYouSureYouWantToStopTheCurrentSession;
  ...
  /// No description provided for @automatedTaskScheduling.
  ///
  /// In en, this message translates to:
  /// **'Automated task scheduling'**
  String get automatedTaskScheduling;
  ...
  /// No description provided for @averageSessionDuration.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @beforeBed.
  ///
  /// In en, this message translates to:
  /// **'Before bed 🌙'**
  String get beforeBed;
  ...
  /// No description provided for @breakDownComplexTasks.
  ///
  /// In en, this message translates to:
  /// **'Break down complex tasks into smaller pieces'**
  String get breakDownComplexTasks;
  ...
  /// No description provided for @chooseYourFocusSession.
  ///
  /// In en, this message translates to:
  /// **'Choose Your Focus Session'**
  String get chooseYourFocusSession;
  ...
  String get considerMoreFrequentBreaks;
  ...
  /// No description provided for @createYourPerfectPomodoroSetup.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @cycles10.
  ///
  /// In en, this message translates to:
  /// **'1-10 cycles'**
  String get cycles10;
  ...
  /// No description provided for @dailyMoodCheckIns.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @defaultWeeklyGoal.
  ///
  /// In en, this message translates to:
  /// **'20'**
  String get defaultWeeklyGoal;
  ...
  /// No description provided for @deleteSubSubtask.
  ///
  /// In en, this message translates to:
  /// **'Delete Subtask'**
  String get deleteSubSubtask;

  /// No description provided for @deleteSubSubtaskConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete \"@taskName\"?'**
  String get deleteSubSubtaskConfirmation;
  ...
  /// No description provided for @deleteSubtaskConfirmation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @duplicateSubSubtask.
  ///
  /// In en, this message translates to:
  /// **'Duplicate Subtask'**
  String get duplicateSubSubtask;

  /// No description provided for @duplicateSubtask.
  ///
  /// In en, this message translates to:
  /// **'Duplicate Subtask'**
  String get duplicateSubtask;
  ...
  /// No description provided for @editSubSubtask.
  ///
  /// In en, this message translates to:
  /// **'Edit Subtask'**
  String get editSubSubtask;
  ...
  /// No description provided for @egMyFocusPower.
  ///
  /// In en, this message translates to:
  /// **'e.g., My Focus Power'**
  String get egMyFocusPower;
  ...
  /// No description provided for @energyAwareScheduling.
  ///
  /// In en, this message translates to:
  /// **'Energy-aware scheduling'**
  String get energyAwareScheduling;
  ...
  String get energyLevelMonitoring;

  /// No description provided for @energyLevelTracking.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @enterTaskManually.
  ///
  /// In en, this message translates to:
  /// **'Enter Task Manually'**
  String get enterTaskManually;
  ...
  /// No description provided for @excellentCompletionRate.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @focusScoreDistribution.
  ///
  /// In en, this message translates to:
  /// **'Focus Score Distribution'**
  String get focusScoreDistribution;
  ...
  /// No description provided for @fridayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Fri'**
  ...
  /// No description provided for @goodnightCheckIn.
  ///
  /// In en, this message translates to:
  /// **'Goodnight check-in 💫'**
  String get goodnightCheckIn;
  ...
  /// No description provided for @greatFocusExtendSessions.
  ///
  /// In en, this message translates to:
  /// **'Great focus! Consider extending sessions to 30-35 min'**
  String get greatFocusExtendSessions;
  ...
  /// No description provided for @hourlyProductivity.
  ///
  /// In en, this message translates to:
  /// **'Hourly Productivity'**
  String get hourlyProductivity;
  ...
  /// No description provided for @howAreYouEndingYourDay.
  ///
  /// In en, this message translates to:
  /// **'How are you ending your day?'**
  String get howAreYouEndingYourDay;
  ...
  /// No description provided for @howAreYouFeelingTonight.
  ///
  /// In en, this message translates to:
  /// **'How are you feeling tonight?'**
  String get howAreYouFeelingTonight;

  /// No description provided for @howAreYouHoldingUp.
  ///
  /// In en, this message translates to:
  /// **'How are you holding up?'**
  String get howAreYouHoldingUp;

  /// No description provided for @howAreYouStartingYourDay.
  ///
  /// In en, this message translates to:
  /// **'How are you starting your day?'**
  String get howAreYouStartingYourDay;
  ...
  /// No description provided for @howDidTodayGoForYou.
  ///
  /// In en, this message translates to:
  /// **'How did today go for you?'**
  String get howDidTodayGoForYou;
  ...
  String get howsYourAfternoonGoing;
  ...
  /// No description provided for @howsYourFocusRightNow.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @immediateTestNotification.
  ///
  /// In en, this message translates to:
  /// **'Immediate Test Notification'**
  String get immediateTestNotification;

  /// No description provided for @immediateTestNotificationDescription.
  ///
  /// In en, this message translates to:
  /// **'This is an immediate test notification.'**
  String get immediateTestNotificationDescription;
  ...
  /// No description provided for @isDueToday.
  ///
  /// In en, this message translates to:
  /// **'is due today'**
  ...
  /// No description provided for @largeTextOptions.
  ///
  /// In en, this message translates to:
  /// **'Large text options'**
  String get largeTextOptions;
  ...
  /// No description provided for @levelThreeSubtaskAdded.
  ///
  /// In en, this message translates to:
  /// **'Level-3 subtask added successfully'**
  String get levelThreeSubtaskAdded;

  /// No description provided for @levelThreeSubtaskDescription.
  ///
  /// In en, this message translates to:
  /// **'This will create a level-3 subtask that can have its own subtasks'**
  String get levelThreeSubtaskDescription;
  ...
  /// No description provided for @longBreakAfterCycles.
  ///
  /// In en, this message translates to:
  /// **'Long break: {longBreak}min after {cycles} cycles'**
  ...
  /// No description provided for @longBreakMin.
  ///
  /// In en, this message translates to:
  /// **'Long Break (min)'**
  String get longBreakMin;
  ...
  /// No description provided for @makeMyCustomTemplate.
  ///
  /// In en, this message translates to:
  /// **'Make my Custom Template 🥕'**
  String get makeMyCustomTemplate;
  ...
  /// No description provided for @min120.
  ///
  /// In en, this message translates to:
  /// **'1-120 min'**
  String get min120;
  ...
  /// No description provided for @min60.
  ///
  /// In en, this message translates to:
  /// **'1-60 min'**
  String get min60;
  ...
  /// No description provided for @mondayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Mon'**
  String get mondayAbbrev;
  ...
  /// No description provided for @newDayNewVibes.
  ///
  /// In en, this message translates to:
  /// **'New day, new vibes! 🌤️'**
  String get newDayNewVibes;
  ...
  /// No description provided for @performanceTips.
  ///
  /// In en, this message translates to:
  /// **'Performance Tips'**
  String get performanceTips;
  ...
  /// No description provided for @productivityAnalysis.
  ///
  /// In en, this message translates to:
  /// **'Productivity Analysis'**
  String get productivityAnalysis;
  ...
  /// No description provided for @recommendedForAdhders.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reducedMotionSettings.
  ///
  /// In en, this message translates to:
  /// **'Reduced motion settings'**
  String get reducedMotionSettings;
  ...
  /// No description provided for @reviewCompletedSessionsWeekly.
  ///
  /// In en, this message translates to:
  /// **'Review your completed sessions weekly to identify patterns'**
  String get reviewCompletedSessionsWeekly;
  ...
  /// No description provided for @saturdayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Sat'**
  String get saturdayAbbrev;
  ...
  /// No description provided for @selectATemplateThatFitsYourWorkStyle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @sessionDurationTrend.
  ///
  /// In en, this message translates to:
  /// **'Session Duration Trend'**
  String get sessionDurationTrend;
  ...
  /// No description provided for @setRealisticSessionGoals.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @shortBreakMin.
  ///
  /// In en, this message translates to:
  /// **'Short Break (min)'**
  ...
  /// No description provided for @startAFocusedWorkSession.
  ///
  /// In en, this message translates to:
  /// **'Start a focused work session'**
  String get startAFocusedWorkSession;
  ...
  /// No description provided for @stayHydratedDuringSessions.
  ///
  /// In en, this message translates to:
  /// **'Stay hydrated during sessions'**
  String get stayHydratedDuringSessions;
  ...
  /// No description provided for @subSubtaskAdded.
  ///
  /// In en, this message translates to:
  /// **'Subtask added successfully'**
  String get subSubtaskAdded;

  /// No description provided for @subSubtaskDeleted.
  ///
  /// In en, this message translates to:
  /// **'Subtask deleted successfully'**
  String get subSubtaskDeleted;

  /// No description provided for @subSubtaskDuplicated.
  ///
  /// In en, this message translates to:
  /// **'Subtask duplicated successfully'**
  String get subSubtaskDuplicated;

  /// No description provided for @subSubtasks.
  ///
  /// In en, this message translates to:
  /// **'sub-subtasks'**
  String get subSubtasks;
  ...
  /// No description provided for @subtaskDetails.
  ///
  /// In en, this message translates to:
  /// **'Subtask Details'**
  String get subtaskDetails;

  /// No description provided for @subtaskDuplicated.
  ///
  /// In en, this message translates to:
  /// **'Subtask duplicated successfully'**
  ...
  /// No description provided for @sundayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Sun'**
  String get sundayAbbrev;
  ...
  /// No description provided for @takeAMomentToCheckIn.
  ///
  /// In en, this message translates to:
  /// **'Take a moment to check in'**
  String get takeAMomentToCheckIn;

  /// No description provided for @takeAMomentToCheckInWithYourself.
  ///
  /// In en, this message translates to:
  /// **'Take a moment to check in with yourself'**
  String get takeAMomentToCheckInWithYourself;
  ...
  /// No description provided for @taskPriorityDistribution.
  ///
  /// In en, this message translates to:
  /// **'Task Priority Distribution'**
  String get taskPriorityDistribution;
  ...
  /// No description provided for @taskRecommendations.
  ///
  /// In en, this message translates to:
  /// **'Task Recommendations'**
  String get taskRecommendations;
  ...
  /// No description provided for @thursdayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Thu'**
  String get thursdayAbbrev;
  ...
  /// No description provided for @tryShorterSessions.
  ///
  /// In en, this message translates to:
  /// **'Try shorter sessions (15-20 min) to maintain focus'**
  String get tryShorterSessions;
  ...
  /// No description provided for @tuesdayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Tue'**
  String get tuesdayAbbrev;
  ...
  /// No description provided for @useFiveMinuteRule.
  ///
  /// In en, this message translates to:
  /// **'Use the 5-minute rule: if a task takes less than 5 minutes, do it now'**
  String get useFiveMinuteRule;
  ...
  /// No description provided for @visualIndicatorsForAiSuggestions.
  ///
  /// In en, this message translates to:
  /// **'Visual indicators for AI suggestions'**
  String get visualIndicatorsForAiSuggestions;
  ...
  /// No description provided for @voiceCommandsSupport.
  ///
  /// In en, this message translates to:
  /// **'Voice commands support'**
  String get voiceCommandsSupport;
  ...
  /// No description provided for @wednesdayAbbrev.
  ///
  /// In en, this message translates to:
  /// **'Wed'**
  String get wednesdayAbbrev;
  ...
  /// No description provided for @weeklyFocusTrend.
  ///
  /// In en, this message translates to:
  /// **'Weekly Focus Trend'**
  ...
  /// No description provided for @weeklySessionCount.
  ///
  /// In en, this message translates to:
  /// **'Weekly Session Count'**
  String get weeklySessionCount;
  ...
  /// No description provided for @whatsYourEnergyLikeThisMorning.
  ///
  /// In en, this message translates to:
  /// **'What\'s your energy like this morning?'**
  String get whatsYourEnergyLikeThisMorning;

  /// No description provided for @whatsYourMoodLikeRightNow.
  ///
  /// In en, this message translates to:
  /// **'What\'s your mood like right now?'**
  String get whatsYourMoodLikeRightNow;
  ...
  /// No description provided for @windingDown.
  ///
  /// In en, this message translates to:
  /// **'Winding down? 🌆'**
  String get windingDown;
  ...
  /// No description provided for @workMin.
  ///
  /// In en, this message translates to:
  /// **'Work (min)'**
  String get workMin;
